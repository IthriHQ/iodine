...
import logoCelo from '@/images/logos/celo.svg'
import logoHuman from '@/images/logos/human.svg'
    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-purple-600">
          ...
          <span className="relative">anti-theft</span>
        </span>{' '}
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/report">Reclaim Your Tokens</Button>
        <Button
          href="/report"
          variant="outline"
      ...
      <div className="mt-36 lg:mt-44">
        ...
        >
          {[
            [
              { name: 'Gnosis', logo: logoGnosis },
              { name: 'Celo', logo: logoCelo },
              { name: 'Human', logo: logoHuman },
            ],                    
